...
| BT_PW_004 | Verifikasi password dengan panjang satu di bawah maksimum | Halaman registrasi/login tersedia. | 1. Masukkan password dengan 19 karakter. 2. Coba kirim formulir. | P@ssw0rdPanjang19 (19 kar.) | Sistem menerima password dan melanjutkan proses. |
